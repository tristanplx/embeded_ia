...
#define AI_NETWORK_MODEL_SIGNATURE     "0x09055ad2e0e15b9e283bd2405c1edfb7"
...
#define AI_TOOLS_DATE_TIME   "2025-03-20T11:32:51+0100"
...
AI_ARRAY_OBJ_DECLARE(
  serving_default_keras_tensor_1200_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
...
/* Tensor #20 */
AI_TENSOR_OBJ_DECLARE(
  serving_default_keras_tensor_1200_output, AI_STATIC,
  20, 0x0,
  AI_SHAPE_INIT(4, 1, 5, 1, 1), AI_STRIDE_INIT(4, 4, 4, 20, 20),
  1, &serving_default_keras_tensor_1200_output_array, NULL)
...
AI_TENSOR_CHAIN_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &serving_default_keras_tensor_1200_output),
  AI_TENSOR_LIST_OBJ_INIT(AI_FLAG_NONE, 1, &gemm_0_output),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    2560, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_IN_NUM, &serving_default_keras_tensor_1200_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &nl_5_output),
  &gemm_0_layer, 0x97854467, NULL)
